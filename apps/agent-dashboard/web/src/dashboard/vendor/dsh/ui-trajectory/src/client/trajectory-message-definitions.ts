...
import type {} from '../../../shims/dsh-agent-types.ts'
 ...
 */
export function registerTrajectoryMessageDefinitions(face: RegistrationFace): void {
  face.conversationEvents.register(trajectoryInboxDefinition)
  face.conversationEvents.register(trajectoryMessageDefinition)
}
