...
import type { ConvViewProps } from '@dsh/ui-conversation'
import type { InjectFace, PropsLocale } from '@dsh/ui-slots'
import type {
...
export function TrajectoryView({
  ...
  const searchIndexTimer = useRef<ReturnType<typeof window.setTimeout> | null>(null)
