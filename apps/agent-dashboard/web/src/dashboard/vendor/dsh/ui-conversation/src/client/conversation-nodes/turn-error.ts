...
import { displayFailureMessage } from '@dsh/runtime'
 ...
 */
export function registerTurnErrorConversationNode(face: RegistrationFace): void {
  face.conversationEvents.register(turnErrorDefinition)
}
