...
import { isReplacementSurfaceEvent } from '@dsh/runtime'
import type { CompactionCheckpointSource } from '../../../../shims/dsh-compaction-checkpoint.ts'
import type {} from '../../../../shims/dsh-compaction-types.ts'
import type {} from '../../../../shims/dsh-commands-types.ts'
import type { ManualCompactionChatData } from '../contract/chat-nodes.ts'
import { chatNode } from './common.ts'

declare module '@dsh/ui-conversation' {
 ...
 */
export function registerCommandConversationNode(face: RegistrationFace): void {
  face.conversationEvents.register(commandDefinition)
}
