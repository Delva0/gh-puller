...
import type { InboxTarget } from '../../../../shims/dsh-agent-types.ts'
 ...
 */
export function registerInboxConversationNodes(face: RegistrationFace): void {
  face.conversationEvents.register(nextTurnInboxDefinition)
  face.conversationEvents.register(nextStepInboxDefinition)
}
