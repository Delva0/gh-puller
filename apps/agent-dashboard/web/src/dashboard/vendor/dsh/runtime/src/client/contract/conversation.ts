...
import type { ToolEventView } from '../../../../shims/dsh-api-remotes.ts'
...
export interface ConversationViewSnapshotMap {
  /** 对话快照(chat-snapshot-builder 注册;dsh 原声明在 runtime barrel 增强)。 */
  'chat': import('../sessions/conversation.ts').ChatSnapshot
}
