...
import { sessionRecallLabels } from '@dsh/runtime'
 ...
 */
export function registerChatConversationView(face: RegistrationFace): void {
  face.conversationViews.register(chatViewDefinition)
}
