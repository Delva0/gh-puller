...
import { IconSearchOutline16 } from '../../../../../ui-primitives/src/index.ts'
...
export const searchToolview = {
  ...
  apply(face: RegistrationFace): void {
    face.slots.inject('tool.call.toolview', function* () {
      yield face.slots.register({ name: 'tool.call.toolview', key: 'grep', locale: NS }, SearchRow)
      yield face.slots.register({ name: 'tool.call.toolview', key: 'glob', locale: NS }, SearchRow)
    })
  },
}
