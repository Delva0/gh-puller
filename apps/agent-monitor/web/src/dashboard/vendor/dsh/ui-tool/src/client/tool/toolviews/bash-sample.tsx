...
// (face.slots.register + ToolRowProps only — never imports the chat domain).
...
} from '../../../../../ui-primitives/src/index.ts'
...
export const bashToolviewSample = {
  ...
  apply(face: RegistrationFace): void {
    face.slots.inject('tool.call.toolview', () =>
      face.slots.register({ name: 'tool.call.toolview', key: 'bash', locale: NS }, BashRow))
  },
}
