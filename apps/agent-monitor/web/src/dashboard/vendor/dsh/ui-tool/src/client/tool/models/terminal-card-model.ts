 ...
 * @module
 */
import { resolveWorkspacePath } from '@dsh/runtime'
import type { TerminalBlockLabels, TerminalBlockProps } from '../../../../../ui-primitives/src/index.ts'
import type { TranslateNS } from '@dsh/ui-slots'
