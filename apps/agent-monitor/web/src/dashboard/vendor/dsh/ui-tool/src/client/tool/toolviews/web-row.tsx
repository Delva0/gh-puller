...
import { IconBrowseOutline16, IconGlobeOutline14 } from '../../../../../ui-primitives/src/index.ts'
import type { PropsLocale } from '@dsh/ui-slots'
...
export const webToolview = {
   ...
   */
  apply(face: RegistrationFace): void {
    face.slots.inject('tool.call.toolview', function* () {
      yield face.slots.register({ name: 'tool.call.toolview', key: 'web_search', locale: NS }, WebRow)
      yield face.slots.register({ name: 'tool.call.toolview', key: 'web_fetch', locale: NS }, WebRow)
    })
  },
}
