...
import type { InjectFace, PropsLocale, PropsRenderSlots, PropsRuntime } from '@dsh/ui-slots'
import type { ToolCallBlock } from '@dsh/runtime'
import type {} from '@dsh/ui-conversation'
import type {} from '../../../../shims/dsh-client-locale.ts'
