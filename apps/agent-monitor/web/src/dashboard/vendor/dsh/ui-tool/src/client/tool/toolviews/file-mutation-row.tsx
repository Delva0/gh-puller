...
import { IconEditOutline16 } from '../../../../../ui-primitives/src/index.ts'
...
export const fileMutationToolview = {
  ...
  apply(face: RegistrationFace): void {
    face.slots.inject('tool.call.toolview', function* () {
      yield face.slots.register({ name: 'tool.call.toolview', key: 'edit', locale: NS }, FileMutationRow)
      yield face.slots.register({ name: 'tool.call.toolview', key: 'write', locale: NS }, FileMutationRow)
    })
  },
}
