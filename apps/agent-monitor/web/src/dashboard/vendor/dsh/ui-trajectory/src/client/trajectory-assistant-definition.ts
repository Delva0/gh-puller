 ...
 */
export function registerTrajectoryAssistantDefinition(face: RegistrationFace): void {
  face.conversationEvents.register(trajectoryAssistantDefinition)
  face.conversationEvents.register(trajectoryTurnEndDefinition)
}
