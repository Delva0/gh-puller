 ...
 */
export function registerTrajectoryCompactionDefinitions(face: RegistrationFace): void {
  face.conversationEvents.register(trajectoryCompactionDefinition)
  face.conversationEvents.register(trajectorySessionEndDefinition)
}
