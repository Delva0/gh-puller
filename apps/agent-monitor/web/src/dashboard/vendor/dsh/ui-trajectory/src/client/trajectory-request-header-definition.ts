 ...
 */
export function registerTrajectoryRequestHeaderDefinition(face: RegistrationFace): void {
  face.conversationEvents.register(trajectoryRequestHeaderDefinition)
}
