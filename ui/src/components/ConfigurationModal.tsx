        ...
        <div className="relative transform overflow-hidden rounded-lg bg-[var(--card-bg)] text-left shadow-xl transition-all sm:my-8 sm:max-w-2xl sm:w-full">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--border-color)]">
            <h3 className="text-lg font-medium text-[var(--accent-primary)]">
              <span className="text-[var(--accent-primary)]">{t("form.configureWiki")}</span>
            </h3>
            <button
              type="button"
              onClick={onClose}
          ...
          <div className="p-6 max-h-[70vh] overflow-y-auto">
            ...
            <div className="mb-4">
              ...
              >
                {
                  Object.entries(SUPPORTED_LANGUAGES).map(([key, value])=> <option key={key} value={key}>{value}</option>)
                }
              </select>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex gap-3">
                ...
                >
                  <div className="flex items-center">
                    <div className="text-left">
                      <div className="font-medium text-sm">{t("form.comprehensive")}</div>
                ...
                >
                  <div className="flex items-center">
                    <div className="text-left">
                      <div className="font-medium text-sm">{t("form.concise")}</div>
                      <div className="text-xs opacity-80">
