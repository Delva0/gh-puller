  ...
  return (
    <div className="mb-4">
      {onToggleTokenSection && (
        ...
        >
          {showTokenSection ? t("form.hideTokens") : t("form.addTokens")}
        </button>
      )}
        ...
        <div className="mt-2 p-4 bg-[var(--background)]/50 rounded-md border border-[var(--border-color)]">
          ...
          <div>
            <label htmlFor="access-token" className="block text-xs font-medium text-[var(--foreground)] mb-2">
              {(t("form.personalAccessToken")).replace('{platform}', platformName)}
            </label>
            <input
              id="access-token"
              type="password"
              ...
              placeholder={(t("form.tokenPlaceholder")).replace('{platform}', platformName)}
