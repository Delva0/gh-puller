...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      {/* Japanese-inspired sun and moon icons. Dark Reader 等扩展会在水合前给初始渲染的 svg 注入 --darkreader-inline-stroke
          等属性,所有新加入初始 SSR 树的 svg 元素(根与每个带 stroke 的子元素)都必须带 suppressHydrationWarning */}
