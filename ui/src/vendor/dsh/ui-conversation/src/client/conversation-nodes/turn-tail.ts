...
import { isAppendSurfaceEvent, toAssistantBlocks } from '@dsh/runtime'
import type {} from '../../../../shims/dsh-llm-retry.ts'
import type {
 ...
 */
export function registerTurnTailConversationNode(face: RegistrationFace): void {
  face.conversationEvents.register(turnTailDefinition)
}
