...
import { isAppendSurfaceEvent } from '@dsh/runtime'
import type {} from '../../../../shims/dsh-tools-types.ts'
 ...
 */
export function registerToolConversationNode(face: RegistrationFace): void {
  face.conversationEvents.register(toolDefinition)
}
